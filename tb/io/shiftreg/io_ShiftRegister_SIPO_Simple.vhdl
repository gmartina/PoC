...
--
-- Entity:          io_ShiftRegister_SIPO_Simple
--
-- Description:
-- -------------------------------------
-- Simple test case for the SIPO shift register controller.
-- This test verifies basic functionality at 5 MHz shift clock:
--   1. Single write operation with known data
--   2. Multiple consecutive writes with different data patterns
...
architecture Simple of io_ShiftRegister_SIPO_TestController is
...
begin
	...
	begin
		SetTestName("io_ShiftRegister_SIPO_Simple");
	...
	begin
		...
		Log(ProcID, "Starting SIPO Shift Register Controller Tests (5 MHz)", INFO);
		Log(ProcID, "==============================================", INFO);
...
-- =============================================================================
-- Configuration: Binds the Simple architecture to the test harness
-- =============================================================================
configuration io_ShiftRegister_SIPO_Simple of io_ShiftRegister_SIPO_TestHarness is
	for TestHarness
		for TestCtrl : io_ShiftRegister_SIPO_TestController
			use entity work.io_ShiftRegister_SIPO_TestController(Simple);
		end for;
	end for;
end configuration;
