...
--
-- Entity:          io_ShiftRegister_SIPO_DaisyChain_Fast
--
-- Description:
-- -------------------------------------
-- Fast (30 MHz shift clock) daisy chain test case for the SIPO shift 
...
architecture DaisyChainFast of io_ShiftRegister_SIPO_DaisyChain_TestController is
...
begin
	...
	begin
		SetTestName("io_ShiftRegister_SIPO_DaisyChain_Fast");
	...
	begin
		...
		Log(ProcID, "Starting SIPO Daisy Chain Tests (30 MHz, 3 IC)", INFO);
		Log(ProcID, "==================================================", INFO);
		...
		Log(ProcID, "==================================================", INFO);
		Log(ProcID, "All 30 MHz daisy chain tests completed!", INFO);
...
-- =============================================================================
configuration io_ShiftRegister_SIPO_DaisyChain_Fast of io_ShiftRegister_SIPO_DaisyChain_TestHarness is
	for TestHarness
		for TestCtrl : io_ShiftRegister_SIPO_DaisyChain_TestController
			use entity work.io_ShiftRegister_SIPO_DaisyChain_TestController(DaisyChainFast);
		end for;
	end for;
end configuration;
